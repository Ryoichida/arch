...
sed -i -e s/#GRUB_COLOR_.*/GRUB_COLOR_.*/g -e s/GRUB_GFXMODE=.*/GRUB_GFXMODE=1920x1080/ -e s@#GRUB_BACKGROUND=.*@GRUB_BACKGROUND=/usr/share/backgrounds/archlinux/simple.png@ /etc/default/grub 
